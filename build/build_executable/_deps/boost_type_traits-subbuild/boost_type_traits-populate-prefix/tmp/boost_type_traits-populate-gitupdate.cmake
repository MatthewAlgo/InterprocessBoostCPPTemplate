...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/matthewalgo/Projects/VSCode/CppBuildSystem/build/build_executable/_deps/boost_type_traits-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/matthewalgo/Projects/VSCode/CppBuildSystem/build/build_executable/_deps/boost_type_traits-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
